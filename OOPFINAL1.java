...
//Inheritance
 class HeroDesign extends HeroInfo{
        ...
        //Method Overriding of Interface
	    @Override
...
public class OOPFINAL1 {
    ...
    public static void main(String[] args) {
        ...
        String country="";
        while (true) {
        System.out.print("Select Country: (1. UK, 2. USA, 3. Philippines, 4. Brazil, 5. Canada): ");        int choice = scan.nextInt();  
        if(choice == 1){
            country = "UK";
            break;
        }else if(choice == 2){
